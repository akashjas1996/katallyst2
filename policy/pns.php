...
<head>
  ...
  <title>POLICIES | Katallyst</title>
  <!-- Font Awesome -->
    ...
    <div style="min-height: 70vh" class="container">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-12">
                    ...
                    <hr>
                    <p>
                        We sell offline courses through our online page. All the courses mentioned are carried away as per the venue of the course.
                    </p>
                </div>
      </div>
    </div>
