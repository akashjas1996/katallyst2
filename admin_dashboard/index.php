        ...
        <div class="card success-color white-text">
          <div class="card-body d-flex justify-content-between align-items-center">
            <div>
              ...
              <p class="mb-0">About Verticals</p>
            </div>
            <div>
              <i class="fas fa-handshake fa-4x text-black-40"></i>
            </div>
          </div>
          <a href="../admin_about/" class="card-footer footer-hover small text-center white-text border-0 p-2">More info<i class="fas fa-arrow-circle-right pl-2"></i></a>
        </div>
      </div>
    </div>
