  ...
  <div style="z-index: 6" class="collapse navbar-collapse danger-color" id="navbarSupportedContent-333">
    <ul class="navbar-nav mr-auto">
      ...
      <?php if(isset($_SESSION['admin_username'])){ ?>
          <li class="nav-item">
            <a class="nav-link" href="../admin_dashboard"><?php echo $_SESSION['admin_name'] ?></a>
          </li>
    ...
    <ul class="navbar-nav ml-auto nav-flex-icons">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-default"
          ...
          <?php if(isset($_SESSION['admin_username'])) 
            echo '<a style="font-weight:bold" class="dropdown-item" href="../admin_dashboard">'.$_SESSION["admin_name"].'</a>';
